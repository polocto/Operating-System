...
What we have demonstrated here is called a **race condition** (or, more specifically, a **data race**): the results **depend on the timing execution** of the code. The result is **indeterminate**. **Multiple threads** executing this code can result in a **race condition**, this code is called **critical section**.
